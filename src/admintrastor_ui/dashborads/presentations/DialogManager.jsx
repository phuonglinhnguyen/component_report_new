...
import {
  DASHBROAD_DIALOG_TYPE_CREATE_GROUP,
  DASHBROAD_DIALOG_TYPE_EDIT_GROUP,
  DASHBROAD_DIALOG_TYPE_CREATE_PROJECT,
  DASHBROAD_DIALOG_TYPE_EDIT_PROJECT
...
function RenderBody(props) {
  const { users, groups, dialogType, dashboard, changeData, muiTheme } = props;
  switch (dialogType) {
    case DASHBROAD_DIALOG_TYPE_CREATE_GROUP:
      return (
        <React.Fragment>
          <TextField
            fullWidth={true}
            value={getDataObject("data.groupNameEditing", dashboard)}
            onChange={event => {
              changeData("data.groupNameEditing", event.target.value);
            }}
            floatingLabelText={
              <Translate value="dashboard.form.input_group_name_title" />
            }
          />
          <br />
        </React.Fragment>
      ...
      return (
        <React.Fragment>
          ...
          >
            ...
            >
              ...
              <TextField
                ...
                onChange={event => {
                  changeData("data.add_project.customer", event.target.value);
                }}
                floatingLabelText={
            ...
            <div style={{ width: "calc(50% - 16px)" }}>
              ...
              <TextField
                ...
                onChange={event => {
                  changeData("data.add_project.folder", event.target.value);
                }}
              />
              <br />
            </div>
          ...
          <TextUser
            ...
            value={getDataObject(
              "data.add_project.project_managers",
              dashboard
            )}
            onUpdateInput={name => {
...
function DialogManager(props: Props) {
  ...
  if (
    props.dialogType === DASHBROAD_DIALOG_TYPE_EDIT_GROUP ||
